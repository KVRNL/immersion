...
**v1.0.0** — 2026-06-30
  - Initial release.
  - Audio-reactive synced lyrics, visualizers, timers, counters, tickers, and goal bars for OBS.
...
- 🐛 **Found a bug?** [Open an issue](https://github.com/KVRNL/immersion/issues/new/choose)
